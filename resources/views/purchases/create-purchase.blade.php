                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <button class="btn btn-outline-success form-control addEventMore" type="button">+ Add Product To Cart</button>
                            </div>
                        </div>
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr class="table-primary">
                                        ...
                                        <td>
                                            <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure you want to proceed purchase?')">
                                            Purchase →
