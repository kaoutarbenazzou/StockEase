        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto my-4">
                    <a href="{{ route('customers.create') }}" class="btn btn-success add-list">➕ Add Customer</a>
                </div>
            </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('customers.edit', $customer->id) }}" class="btn btn-outline-dark btn-sm mx-1"><i class="fas fa-edit"></i></a>
