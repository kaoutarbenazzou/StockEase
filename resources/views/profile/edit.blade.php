...
<div class="container-xl px-4 mt-4">
    ...
    <nav class="nav nav-borders">
        ...
        <a class="nav-link" href="{{ route('profile.settings') }}">Settings ⚙️</a>
    </nav>
            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <!-- check if user uploaded thei own profile pic or we use the default one -->
                        <img class="img-account-profile rounded-circle mb-2" src="{{ $user->photo ? asset('storage/profile/'.$user->photo) : asset('assets/img/illustrations/profiles/defaultProfile.png') }}" alt="" id="image-preview" />
