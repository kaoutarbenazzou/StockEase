...
@section('content')
<!-- <header class="page-header page-header-compact page-header-dark border-bottom bg-dark text-white mb-4"> -->
...
<div class="container-xl px-4 mt-4">
    ...
    <nav class="nav nav-borders">
        ...
        <a class="nav-link active" href="{{ route('profile.settings') }}">Settings ⚙️</a>
    </nav>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <p>⚠️ Attention: Deleting your account is a permanent ⚠️</p>
                    <button class="btn btn-danger" type="button">Delete My Account</button>
                </div>
            </div>
        </div>
    </div>
