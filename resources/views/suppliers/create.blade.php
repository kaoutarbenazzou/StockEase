                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('name') is-invalid @enderror" id="name" name="name" type="text" placeholder="Enter supplier's full name. " value="{{ old('name') }}" />
                            @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('email') is-invalid @enderror" id="email" name="email" type="text" placeholder="Enter supplier's email address." value="{{ old('email') }}" />
                            @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <!-- Form Group (shopname) -->
                        <div class="mb-3">
                            <label class="small mb-1" for="shopname"> <span class="text-danger">*</span></label>
                            <input class="form-control form-control-solid @error('shopname') is-invalid @enderror" id="shopname" name="shopname" type="text" placeholder="Enter supplier's shop name." value="{{ old('shopname') }}" />
                            @error('shopname')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('phone') is-invalid @enderror" id="phone" name="phone" type="text" placeholder="Enter supplier's phone number." value="{{ old('phone') }}" />
                            @error('phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('type') is-invalid @enderror" id="type" name="type">
                                    ...
                                    <option value="Whole Seller" @if(old('type') == 'Whole Seller')selected="selected"@endif>Manufacturer</option>
                                    <option value="Whole Seller" @if(old('type') == 'Whole Seller')selected="selected"@endif>Importer</option>
                                </select>
                                @error('type')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="account_holder">Supllier's Account Holder</label>
                                <input class="form-control form-control-solid @error('account_holder') is-invalid @enderror" id="account_holder" name="account_holder" type="text" placeholder="Enter account holder's name." value="{{ old('account_holder') }}" />
                            ...
                            <div class="col-md-6">
                                <label class="small mb-1" for="account_number">Supplier's Account Number</label>
