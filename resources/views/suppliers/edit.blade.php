            ...
            <div class="col-xl-8">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Group (shopname) -->
                        <div class="mb-3">
                            <label class="small mb-1" for="shopname">Shop Name <span class="text-danger">*</span></label>
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('type') is-invalid @enderror" id="type" name="type">
                                    ...
                                    <option value="Whole Seller" @if(old('type', $supplier->type) == 'Whole Seller')selected="selected"@endif> Manufacturer</option>
                                    <option value="Whole Seller" @if(old('type', $supplier->type) == 'Whole Seller')selected="selected"@endif> Importer</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name">
                                    ...
                                    <option value=" BMCE" @if(old('bank_name', $supplier->bank_name) == ' BMCE')selected="selected"@endif> BMCE</option>
                                    <option value="BP" @if(old('bank_name', $supplier->bank_name) == 'BP')selected="selected"@endif>BP</option>
                                    <option value="BMCI" @if(old('bank_name', $supplier->bank_name) == 'BMCI')selected="selected"@endif>BMCI</option>
                                    <option value="CIH" @if(old('bank_name', $supplier->bank_name) == 'CIH')selected="selected"@endif>CIH</option>
                                    <option value="Other" @if(old('bank_name', $supplier->bank_name) == 'Other')selected="selected"@endif>Other</option>
                                </select>
                                @error('bank_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
