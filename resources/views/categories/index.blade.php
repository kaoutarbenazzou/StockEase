        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto my-4">
                    <a href="{{ route('categories.create') }}" class="btn btn-success add-list">➕Add Category</a>
                </div>
            </div>
            ...
            <nav class="mt-4 rounded" aria-label="breadcrumb">
                <ol class="breadcrumb px-3 py-2 rounded mb-0">
                    ...
                    <li class="breadcrumb-item active">🗂️ Categories</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('categories.edit', $category->slug) }}" class="btn btn-outline-dark btn-sm mx-1"><i class="fas fa-edit"></i></a>
