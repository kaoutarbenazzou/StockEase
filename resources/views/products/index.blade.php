        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto my-4">
                    ...
                    <a href="{{ route('products.create') }}" class="btn btn-success add-list my-1"></i>➕ Add Product</a>
                </div>
                <!-- cashier -->
            </div>
                        ...
                        <table class="table table-striped align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $product->stock }}</td> <!-- cashier -->
                                     <td>{{ $product->unit->name }}</td> <!-- cashier -->
                                    <td>{{ $product->selling_price }}</td>
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('products.show', $product->id) }}" class="btn btn-outline-success btn-sm mx-1"><i class="fa-solid fa-eye"></i></a>
                                            <a href="{{ route('products.edit', $product->id) }}" class="btn btn-outline-dark btn-sm mx-1"><i class="fas fa-edit"></i></a>
